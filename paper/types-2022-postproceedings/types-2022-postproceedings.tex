...
The closest related work to Supervisionary is \emph{VeriML}, an ML-like higher-order programming language extended with limited dependent-types that range over terms and theorems of Gordon's HOL~\cite{DBLP:conf/icfp/StampoulisS10}.
