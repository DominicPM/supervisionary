...
/// The polymorphic Hilbert epsilon constant, lifted into a term.
pub const TERM_HILBERT_EPSILON: Term = Term::Constant {
    constant: PREALLOCATED_HANDLE_CONSTANT_HILBERT_EPSILON,
    tau: PREALLOCATED_HANDLE_TYPE_CHOICE_PRINCIPLE,
};
